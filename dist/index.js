(function (global, factory) {
	if (typeof define === 'function' && define.amd) {
		define(['exports', 'mtil/object/mixin', 'stream'], factory);
	} else if (typeof exports !== 'undefined') {
		factory(exports, require('mtil/object/mixin'), require('stream'));
	} else {
		var mod = {
			exports: {}
		};
		factory(mod.exports, global.mixin, global.stream);
		global.index = mod.exports;
	}
})(this, function (exports, _mtilObjectMixin, _stream) {
	'use strict';
  ...
  */
	...
	var _mixin = _interopRequire(_mtilObjectMixin);
  ...
  */
   ...
   */
    ...
    * @type {Object}
    */
			this.options = _mixin({}, Tunic.defaults, options);
		}
    ...
    * @static
    */
			value: function navMaker(file, ast) {
				var tagNode,
