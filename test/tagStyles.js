...
test('atCurlyDash', async assert => {
	...
	assert.same(parse(src, { tagStyle: tagStyles.atCurlyDash }), {
		type: 'Documentation',
		blocks: [
			{
				type: 'Block',
				comment: {
					...
					tags: [
						{ type: 'Tag', tag: 'arg', kind: 'Type', name: 'name', description: 'Description.' },
						{ type: 'Tag', tag: 'arg', kind: 'Type', name: 'name', description: 'Description.' },
			...
			},
			{
				...
				comment: {
					...
					description: 'Description.\n\nDescription.',
					tags: [
						{ type: 'Tag', tag: 'tag', kind: 'Type', name: 'name', description: 'Description.' },
						{ type: 'Tag', tag: 'tag', kind: 'Type', name: '', description: 'name Description.' },
						{ type: 'Tag', tag: 'tag', kind: 'Type', name: '', description: 'Description.' },
						{ type: 'Tag', tag: 'tag', kind: 'Type', name: '', description: 'Description.' },
						{ type: 'Tag', tag: 'tag', kind: '', name: 'name', description: 'Description.' },
						{ type: 'Tag', tag: 'tag', kind: '', name: '', description: 'name Description.' },
...
test('backslashCurlyDash', async assert => {
	...
	assert.same(parse(src, { tagStyle: tagStyles.backslashCurlyDash }), {
		type: 'Documentation',
		blocks: [
			{
				type: 'Block',
...
test('colon', async assert => {
	...
	assert.same(parse(src, { tagStyle: tagStyles.colon }), {
		type: 'Documentation',
		blocks: [
			{
				type: 'Block',
